/**
 * CSV Parser — ported from contracting-portal/src/lib/csvParser.ts
 *
 * Handles multi-line headers, quoted fields, sub-header detection, and
 * sparse-row filtering. Used by roster upload and import flows.
 */
