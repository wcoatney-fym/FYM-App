/**
 * Roster Normalizer — ported from contracting-portal/src/lib/rosterNormalizer.ts
 *
 * Maps arbitrary CSV column headers to canonical CRM roster headers
 * and normalizes row data (gender → profile image, seat numbering, etc.).
 */
