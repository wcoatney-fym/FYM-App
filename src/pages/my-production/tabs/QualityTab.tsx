/**
 * My Production — Quality Tab
 *
 * Full 8-metric tile grid in §13.7 priority order (P7):
 *   Policies Taken → 30d Ret → 90d Ret → 9-mo Pers → 13-mo Pers → UW Share → Save Rate → Attn Rate
 *
 * Retention gauge + draft distribution + at-risk breakdown.
 * Scoped to the logged-in agent's own data.
 */
