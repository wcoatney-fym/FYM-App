/**
 * My Production — Volume Tab
 *
 * Four KPI tiles (MTD AP, Apps Submitted, AP/App, Apps/Active Day).
 * Below: AP trend chart + product family breakdown bar chart.
 * Mirrors agent-detail VolumeTab but scoped to the logged-in agent.
 */
...
export function VolumeTab({ stats, trend, productMix, dateRange }: VolumeTabProps) {
  ...
  // Active business days elapsed this month
  const now = new Date();
