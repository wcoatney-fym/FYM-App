/**
 * Agent Detail — Policies Tab (§11.3.4)
 *
 * Flat table of every active policy attached to this agent.
 * Columns: Policy #, Product, Status, AP, Effective Date, Paid To Date, Drafts, Flag.
 * Searchable, filterable, sortable, exportable.
 */
...
export function PoliciesTab({ policies, agentId, writingNumber }: PoliciesTabProps) {
  ...
  function exportCSV() {
    ...
    a.href = url;
    a.download = `agent-${writingNumber || agentId}-policies.csv`;
    a.click();
