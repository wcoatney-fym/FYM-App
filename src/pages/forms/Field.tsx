/**
 * Field intake form — ported from contracting-portal
 *
 * Public-facing form for Field agents. Includes CTM acknowledgment.
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600 mt-4 max-w-2xl mx-auto">
            Please note that you are completing this form as a FIELD agent. If you are not a face to face agent,
