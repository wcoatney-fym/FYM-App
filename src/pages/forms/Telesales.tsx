/**
 * Telesales intake form — ported from contracting-portal
 *
 * Public-facing form for Telesales agents. Includes CTM acknowledgment.
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600 mt-4 max-w-2xl mx-auto">
            Please note that you are completing this form as a Telesales agent. If you are not selling over the phone,
