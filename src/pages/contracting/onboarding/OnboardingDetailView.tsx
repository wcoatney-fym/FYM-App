/**
 * OnboardingDetailView — Agency onboarding detail, adapted from OnboardingDetailPage
...
export function OnboardingDetailView({ slug, onBack }: OnboardingDetailViewProps) {
    ...
    return (
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <Button variant="link" className="mt-4" onClick={onBack}>
            ← Back to list
          </Button>
        </CardContent>
      </Card>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <h2 className="text-xl font-bold tracking-tight">{agency.agency_name}</h2>
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <h2 className="text-xl font-bold tracking-tight mt-2">Edit: {agency.agency_name}</h2>
      </div>
